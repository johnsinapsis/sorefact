...
<!-- Inicio del componente -->
          <section class="col-lg-7 connectedSortable">
            <div class="box box-success">
              ...
              {!! Form::open(['class' => 'form-horizontal', 'role' => 'form', 'url' => 'infoedad']) !!}
                          ...
                          <input type="hidden" id="select" value="0">
                           ...
                           <div class="form-group">
                                ...
                                <div class="input-group col-md-8">                                 
                                    <select name="edad" id="edad" class="form-control input-sm" style="width:130px;">
                                      <option value="0">Todas</option>
                                      <option value="1">Cartera a 60 días</option>
                                      <option value="2">Cartera a 90 días</option>
                                      <option value="3">Cartera a 120 días</option>
                                      <option value="4">Mayor a 120 días</option>
                                    </select>
                                </div>
